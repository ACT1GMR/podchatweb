...
//styling
import style from "../../../styles/pages/box/BoxSceneInputEditing.scss";
...
export default class BoxSceneInputEditing extends Component {
  ...
  render() {
    ...
    if (isEditing) {
      ...
      return (
        <Container relative className={style.BoxSceneInputEditing}>
          <Paper colorBackgroundLight borderRadius="5px 5px 0 0">
            <Container inline>
              ...
              <Container inline>
                {editObject.image ?
                  <Container className={style.BoxSceneInputEditing__ImageContainer} inline>
                    <div className={style.BoxSceneInputEditing__Image} style={{backgroundImage: `url(${editObject.image})`}}/>
                  </Container>
                  : ""}
                {editObject.text}
              </Container>
