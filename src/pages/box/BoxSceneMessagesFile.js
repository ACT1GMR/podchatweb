...
import {MdDoneAll, MdDone, MdDelete, MdEdit, MdReply, MdChatBubbleOutline, MdForward, MdSchedule} from "react-icons/lib/md";
        ...
        <Container inline inSpace relative maxWidth="50%" minWidth="220px"
          ...
          <Paper colorBackgroundLight borderRadius={5}>
            ...
            <PaperFooter>
              ...
              {el.type !=="PENDING" && messageControlShow && el.id === messageControlId ?
